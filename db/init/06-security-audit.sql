-- Module 3.2: Industrial Grade Audit Logging (Robust Version)
CREATE SCHEMA IF NOT EXISTS fabric_admin;

-- 1. Audit Logs Table (with better defaults)
...
BEGIN
    ...
    IF (TG_OP = 'DELETE') THEN
        RAISE NOTICE 'Audit Log: DELETE on %', TG_TABLE_NAME;
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
        RAISE NOTICE 'Audit Log: UPDATE on %', TG_TABLE_NAME;
    ...
    ELSIF (TG_OP = 'INSERT') THEN
        RAISE NOTICE 'Audit Log: INSERT on %', TG_TABLE_NAME;
