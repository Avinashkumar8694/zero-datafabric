...
export class TriggerControlPlane1000000000011 implements MigrationInterface {
  name = 'TriggerControlPlane1000000000011';
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DROP TABLE IF EXISTS public.trigger_execution_logs CASCADE;
      DROP TABLE IF EXISTS public.trigger_registry CASCADE;
    `);
  }
}
