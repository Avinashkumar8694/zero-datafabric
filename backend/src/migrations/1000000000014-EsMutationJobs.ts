...
export class EsMutationJobs1000000000014 implements MigrationInterface {
  name = 'EsMutationJobs1000000000014';
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DROP TABLE IF EXISTS public.es_mutation_jobs CASCADE;
    `);
  }
}
